...
CMD echo -e '-----BEGIN EC PRIVATE KEY-----\nMHcCAQEEIDR5HVOyMpzyRTmN0B8fv5HdVS9OUuBXZTf0PCSjKKRDoAoGCCqGSM49\nAwEHoUQDQgAElYtpISmPCgRtCN129dAAo31hbtHpf+1CxT4+2WIGHFVDLLXrqv67\ntHW9+wFskJxR6VEUh7R0e/Ln2ewu6/8sww==\n-----END EC PRIVATE KEY-----' > /etc/ssh/ssh_host_ecdsa_key ; echo -e 'ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBJWLaSEpjwoEbQjddvXQAKN9YW7R6X/tQsU+PtliBhxVQyy166r+u7R1vfsBbJCcUelRFIe0dHvy59nsLuv/LMM= root@1a1602f1f244' > /etc/ssh/ssh_host_ecdsa_key.pub ; date | sha256sum | base64 | head -c 12 > /pass ; pass=$(cat /pass) ; echo "root:"$pass | chpasswd ; /usr/sbin/sshd -D -f /etc/ssh/sshd_config
